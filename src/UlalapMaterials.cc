...
//
    ...
    //Enviromat material non realistic
    G4Material* EnviroMATNoZr = new G4Material("EnviroMATNoZr", 1.52*g/cm3, 36);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ag"), 0.00000088);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Al"), 0.01216300);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_As"), 0.00002070);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_B"),  0.00002690);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ba"), 0.00046400);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Be"), 0.00000048);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_C"),  0.33789707);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ca"), 0.05026500);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Cd"), 0.00000320);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ce"), 0.00004010);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Co"), 0.00001290);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Cr"), 0.00010300);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Cu"), 0.00043000);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Fe"), 0.07200000);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_H"),  0.05631646);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Hg"), 0.00000041);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_K"),  0.00223200);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Li"), 0.00001430);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Mg"), 0.00969000);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Mn"), 0.00073700);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Mo"), 0.00000680);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Na"), 0.00065000);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ni"), 0.00005920);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_O"),  0.45052915);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_P"),  0.00155200);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Pb"), 0.00076400);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_S"),  0.00191600);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sb"), 0.00000550);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Se"), 0.00000078);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sn"), 0.00034000);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sr"), 0.00011400);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ti"), 0.00053000);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Tl"), 0.00000019);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_U"),  0.00000078);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_V"),  0.00002720);
    EnviroMATNoZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Zn"), 0.001114);

    //Enviromat material non realistic
    G4Material* EnviroMATInitialZr = new G4Material("EnviroMATInitialZr", 1.52*g/cm3, 36);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ag"),0.00000088);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_ALUMINUM_OXIDE"),0.0284042553191489);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_As"),0.0000207);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_B"),0.0000269);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ba"),0.000464);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Be"),0.00000048);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_CALCIUM_CARBONATE"),0.135);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Cd"),0.0000032);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ce"),0.000001);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Co"),0.0000129);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Cr"),0.000103);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Cu"),0.00043);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_FERRIC_OXIDE"),0.0206895652173913);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Hg"),0.00000041);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_K"),0.002232);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Li"),0.0000143);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_MAGNESIUM_OXIDE"),0.01615);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Mn"),0.000737);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Mo"),0.0000068);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_SODIUM_MONOXIDE"),0.000878378378378378);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ni"),0.0000592);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_P"),0.001552);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Pb"),0.0000034);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_S"),0.001916);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sb"),0.0000055);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Se"),0.00000078);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sn"),0.00034);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sr"),0.000114);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_TITANIUM_DIOXIDE"),0.000894375);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Tl"),0.0000001);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_U"),0.00000078);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_V"),0.0000272);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Zn"),0.001114);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_Zr"),0.000129);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_SILICON_DIOXIDE"),0.6);
    EnviroMATInitialZr->AddMaterial(nistManager->FindOrBuildMaterial("G4_WATER"),0.188667896085081);
    
    
    G4Material* EnviroMAT = new G4Material("EnviroMAT", 1.52*g/cm3, 37);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ag"),0.00000088);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_ALUMINUM_OXIDE"),0.0284042553191489);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_As"),0.0000207);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_B"),0.0000269);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ba"),0.000464);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Be"),0.00000048);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_CALCIUM_CARBONATE"),0.135);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Cd"),0.0000032);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ce"),0.000001);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Co"),0.0000129);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Cr"),0.000103);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Cu"),0.00043);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_FERRIC_OXIDE"),0.106173913043478);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Hg"),0.00000041);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_K"),0.002232);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Li"),0.0000143);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_MAGNESIUM_OXIDE"),0.01615);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Mn"),0.000737);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Mo"),0.0000068);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_SODIUM_MONOXIDE"),0.000878378378378378);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Ni"),0.0000592);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_P"),0.001552);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Pb"),0.000764);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_S"),0.001916);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sb"),0.00001);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Se"),0.00000078);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sn"),0.00034);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sr"),0.00015);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_TITANIUM_DIOXIDE"),0.000894375);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Tl"),0.0000001);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_U"),0.00000078);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_V"),0.0000272);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Zn"),0.001114);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Zr"),0.0009932);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Rb"),0.000075);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_SILICON_DIOXIDE"),0.6);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_WATER"),0.101443248258994);
    ...
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Pb"),0.000764);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_S"),0.001916);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sb"),0.0000055);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Se"),0.00000078);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sn"),0.00034);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sr"),0.00015);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_TITANIUM_DIOXIDE"),0.000894375);
    ...
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Zr"),0.0009932);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_SILICON_DIOXIDE"),0.6);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_WATER"),0.101522748258994);
    ...
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Se"),0.00000078);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sn"),0.00034);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Sr"),0.000114);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_TITANIUM_DIOXIDE"),0.000894375);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Tl"),0.0000001);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_U"),0.00000078);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_V"),0.0000272);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Zn"),0.001114);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_Zr"),0.001528);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_SILICON_DIOXIDE"),0.6);
    EnviroMAT->AddMaterial(nistManager->FindOrBuildMaterial("G4_WATER"),0.101023948258995);
    */
